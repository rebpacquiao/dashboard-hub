    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      >
        <div class="relative drop-shadow-2">
          <img src="@/assets/images/user/reb-profile.jpg" class="rounded-full" alt="profile" />
          <label
            for="profile"
      ...
      <div class="mt-4">
        <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">Reboden Pacquiao</h3>
        ...
        <div class="mx-auto max-w-180">
          ...
          <p class="mt-4.5 text-sm font-normal">
            With 11 years of experience in the Information Technology Industry, I am a skilled
            Front-end Web Developer adept at working both independently and collaboratively within a
            team. My expertise lies in crafting user-friendly websites for various companies,
            employing technologies such as React.js, Angular, and Vue 3, in addition to my
            proficiency in WordPress, JavaScript, HTML 5, Bootstrap, CSS3, jQuery, and Ajax. I bring
            a strong foundation in front-end development, coupled with a commitment to delivering
            high-quality and visually appealing web solutions.
          </p>
        </div>
        ...
        <div class="mt-6.5">
          ...
          <div class="flex items-center justify-center gap-3.5">
            ...
            <a
              href="https://www.linkedin.com/in/reb-pacquiao/"
            ...
            <a
              href="https://github.com/rebpacquiao"
              class="hover:text-primary"
              name="social-icon"
              aria-label="social-icon"
            >
