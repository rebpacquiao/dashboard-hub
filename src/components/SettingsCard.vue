...
const formData = ref({
  fullName: 'Reboden Pacquiao',
  phoneNumber: '09289553913',
  emailAddress: 'reb.pacquiao@gmail.com',
  username: 'reb_pacquiao23',
  bio: 'With 11 years of experience in the Information Technology Industry, I am a skilled Front-end Web Developer adept at working both independently and collaboratively within a team. My expertise lies in crafting user-friendly websites for various companies, employing technologies such as React.js, Angular, and Vue 3, in addition to my proficiency in WordPress, JavaScript, HTML 5, Bootstrap, CSS3, jQuery, and Ajax. I bring a strong foundation in front-end development, coupled with a commitment to delivering high-quality and visually appealing web solutions.'
})

import userPhoto from '@/assets/images/user/reb-profile.jpg'
          ...
          <form @submit.prevent="handlePhotoSubmit">
            ...
            <div class="mb-4 flex items-center gap-3">
              <div class="h-14 w-14 rounded-full">
                <img :src="userPhoto" class="rounded-full" alt="User" />
              </div>
              <div>
